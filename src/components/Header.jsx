...
function Header() {
  return (
    <>
      <HeaderBg />
      <div className="inset-0 px-3 xs:px-8 lg:px-32 w-full z-10 fixed top-0 h-14 lg:h-[4.8rem] text-theme-light fill-theme-light">
        <ul className="w-full border-b-[.1px] border-theme-light flex items-center justify-between h-full">
